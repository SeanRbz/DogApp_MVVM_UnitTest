...
): FlowUseCase<String, RandomBreedImageResponse>(ioDispatcher) {

    override fun execute(parameters: String): Flow<Result<RandomBreedImageResponse>> {
        return repository.getBreedRandomImage(breedName = parameters)
    }
}